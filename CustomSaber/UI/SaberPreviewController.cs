...
{
    public class SaberPreviewController : VRUIViewController
    {
        ...
        {
            RectTransform container = new GameObject("SaberPreviewContainer", typeof(RectTransform)).transform as RectTransform;
